###########################################################################
## Makefile generated for component 'samerHARDWARE0x2DPOTread_restored_from_autosave'. 
## 
## Makefile     : samerHARDWARE0x2DPOTread_restored_from_autosave.mk
## Generated on : Wed Jul 08 03:28:03 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/samerHARDWARE0x2DPOTread_restored_from_autosave.elf
...
PRODUCT_NAME              = samerHARDWARE0x2DPOTread_restored_from_autosave
MAKEFILE                  = samerHARDWARE0x2DPOTread_restored_from_autosave.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2025b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2025b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/SAMERF~1/DOWNLO~1/PC_ARD~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/samerHARDWARE0x2DPOTread_restored_from_autosave.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/samerHARDWARE0x2DPOTread_restored_from_autosave_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/cores/arduino -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/variants/mega -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(ARDUINO_AVR_ROOT)/tools/avr-gcc/$(AVR_GCC_LIB_VERSION)/avr/include
...
DEFINES_STANDARD = -DMODEL=samerHARDWARE0x2DPOTread_restored_from_autosave -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o xcp_ext_mode.o samerHARDWARE0x2DPOTread_restored_from_autosave.o samerHARDWARE0x2DPOTread_restored_from_autosave_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/samerHARDWARE0x2DPOTread_restored_from_autosave_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/samerHARDWARE0x2DPOTread_restored_from_autosave_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/samerHARDWARE0x2DPOTread_restored_from_autosave_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
ert_main.o : $(START_DIR)/samerHARDWARE0x2DPOTread_restored_from_autosave_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


samerHARDWARE0x2DPOTread_restored_from_autosave.o : $(START_DIR)/samerHARDWARE0x2DPOTread_restored_from_autosave_ert_rtw/samerHARDWARE0x2DPOTread_restored_from_autosave.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


samerHARDWARE0x2DPOTread_restored_from_autosave_data.o : $(START_DIR)/samerHARDWARE0x2DPOTread_restored_from_autosave_ert_rtw/samerHARDWARE0x2DPOTread_restored_from_autosave_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
